...
exports.getHtmlForResetPassword = void 0;
const getHtmlForResetPassword = ({ username, resetUrl }) => {
              ...
              <table class="email-content" width="100%" cellpadding="0" cellspacing="0" role="presentation">
                <tr>
                  <td class="email-masthead">
                    <a href=${process.env.APP_HOSTED_URL} class="f-fallback email-masthead_name">
...
exports.getHtmlForResetPassword = getHtmlForResetPassword;
